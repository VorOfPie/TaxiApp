...
public interface CarApi {
    ...
    Mono<ResponseEntity<CarResponse>> updateCar(@PathVariable Long id, @RequestBody CreateCarRequest createCarRequest);

    @Operation(summary = "Get car details by ID")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get a list of cars with optional filters")
    @ApiResponses(value = {
