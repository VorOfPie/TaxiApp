Feature: Driver Management
  ...
  Scenario: Successfully create a new driver
    ...
    When I create a driver with first name "John", last name "Doe", phone number "+1234567890", email "john.doe@example.com", gender "Male"
  ...
  Scenario: Prevent creating a driver with an invalid phone number
    When I create a driver with invalid phone and first name "Jane", last name "Doe", phone number "invalid-phone", email "john.doe@example.com", gender "Female"
  ...
  Scenario: Update an existing driver
    ...
    When I update the driver with first name "Jane", last name "Doe", phone number "+9876543210", email "john.doe@example.com", gender "Female", and car license plate "DEF456"
  ...
  Scenario: Update a non-existing driver
    When I try to update a driver with id 9999, first name "Jane", last name "Doe", phone number "+9876543210", email "john.doe@example.com", gender "Female", and car license plate "DEF456"
  ...
  Scenario: Filter drivers by last name with pagination
    Given the following drivers exist:
      | firstName | lastName | phone       | email                  | gender | cars                      |
      | John      | Doe      | +1234567890 | john.doe@example.com   | Male   | Toyota Camry ABC123       |
      | Jane      | Doe      | +7876543210 | jane.doe@example.com   | Female | NotToyota NotCamry CBA123 |
      | Jack      | Smith    | +1122334455 | jack.smith@example.com | Male   | Toyota Camry ACB123       |
